...
public class Hero extends GameCharacter {
    ...
    public void renderGUI(SpriteBatch batch, BitmapFont font) {
        ...
        strBuilder.append("Level: ").append(charLevel).append("\n");
        strBuilder.append("Weapon: ").append(weapon.getTitle()).append(" [").append((int)(weapon.getMinDamage()*power)).append("-").append((int)(weapon.getMaxDamage()*power)).append("]\n");
