...
public class GameController {
    ...
    private TextObjectController textObjectController;
    ...
    public TextObjectController getTextObjectController() {
        return textObjectController;
    }
    ...
    public GameController() {
        ...
        this.textObjectController = new TextObjectController(this);
    ...
    public void update(float dt) {
        ...
        textObjectController.update(dt);
